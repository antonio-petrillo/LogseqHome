...
+ The [[[https://www.google.com/search?q=computer+networking+a+top+down+approach&oq=computer+networking+a+top+down+approach+&aqs=chrome..69i57j69i59j69i65j69i60l2.3510j0j7&sourceid=chrome&ie=UTF-8][book]] focus on ~unidirectional data transfer~, the ~full duplex~ is similar but to long to explain.
** Continue