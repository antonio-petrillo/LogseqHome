...
* Buffers
[[../assets/tcp_buffers.png]]{:height 253, :width 589}
* Maximum Segment Size (MSS)
:PROPERTIES:
:id: 638f4ca9-1e6c-47be-b5c4-68b7dfcfc0f7
:END:
...
$$TCP transmission \in [\frac{W}{2\cdot RTT}, \frac{W}{RTT}]$$
...
**** Explicit notification *The Modern Approach* aka *ECN* (Explicit Congestion Notification)
